...
| `v0.2.3` | Core logical surface | First-class nominal names, `~` direct relations and relation binding, `[T]` options, explicit list literals, multiline delimited values, codec and migration evidence |
